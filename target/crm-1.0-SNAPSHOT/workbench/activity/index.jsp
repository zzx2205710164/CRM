...
<script type="text/javascript">
	...
	$(function(){
				...
				success : function (data) {
					...
					/*
						<select id="create-marketActivityOwner">
							<option value="202cb962ac59075b964b07152d234b70">张三</option>
							<option value="202cb962ac59075b964b07152d234b70">李四</option>
						</select>

						$("#create-marketActivityOwner").val("202cb962ac59075b964b07152d234b70");
					 */
		...
		//为保存按钮绑定事件，执行添加操作
		//create-owner,create-name,create-startDate,create-endDate,create-cost,create-description
	...
	/*
	    ...
	    （1）点击左侧菜单中的市场“活动列表”超链接，需要调用pageList()方法
	    （2）创建，修改，删除后需要刷新市场活动列表，需要调用pageList()方法
	    （3）点击查询按钮的时候，需要调用pageList()方法
	    （4）点击分页组件的时候，需要调用pageList()方法
	...
	function pageList(pageNo,pageSize) {
		...
		//查询前，将隐藏域中保存的信息提取出来，重新赋值到搜索框中
		$("#search-name-name").val($.trim($("#hidden-name").val()));
